...
import nftgirl from '../public/fake-NFT_girl.png'
import nftboy from '../public/fake-NFT_boy.png'
        ...
        <nav className='flex flex-col text-white text-sm lg:text-xl'>
          ...
          <div className='flex flex-col lg:flex-row xl:mx-10 2xl:px-20 2xl:mx-auto'>
            ...
            <div className='flex flex-col md:flex-row md:py-10 lg:flex-col lg:my-32 lg:pr-40 2xl:flex-row 2xl:w-full 2xl:pr-0 2xl:justify-center'>
              <img className='mx-auto size-2/4 p-1 rounded-xl sm:max-w-60 mb-4 md:size-1/3 md:mr-3 lg:size-full lg:mx-0 lg:w-72 xl:w-96 2xl:w-60' src= {nftgirl} />
              <img className='mx-auto size-2/5 p-1 rounded-xl sm:max-w-60 md:size-1/4 md:ml-3 md:mt-8 lg:size-full lg:mx-0 lg:mt-0 lg:w-72 xl:w-96 2xl:w-60' src= {nftboy} />
            </div>
